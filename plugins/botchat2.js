...
runtime = process.uptime()
					...
					//m.reply(teks)
conn.sendMessage(m.chat, `Lebih Baik Salam Bro...`, 'conversation', {quoted: m, thumbnail: img2, contextInfo:{externalAdReply: {title: teks, body: `${run}`, sourceUrl: namagithub, thumbnail: img1}}})
}
